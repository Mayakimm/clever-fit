class WorkoutsController < ApplicationController
  ...
  def add_exercise
    ...
    if @workout_exercise.save
      redirect_to workout_path(@workout, from_freestyle: params[:from_freestyle]), notice: 'Exercise added successfully!💪'
    else
  ...
  def update
    ...
    if @workout.update(workout_params)
      redirect_to workout_path(@workout, from_freestyle: params[:from_freestyle])
    else
      render :edit
    end
  end
